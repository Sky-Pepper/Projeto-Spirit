...
def organize_by_extension(directory):
    ...
    for filename in os.listdir(directory):
        ...
        if os.path.isfile(file_path):
            ...
            folder_name = get_folder_for_extensions(
                extension,
                extensions_map
            )
...
def main():
    ...
    while True:
        print("\n\033[36mFile.org - Escolha uma opção:")
        print("\033[32m1 - Organizar por tipo de arquivo")
        print("\033[33m2 - Organizar por data")
        print("\033[31m3 - Sair\033[m")
        ...
        if choice == "1":
            ...
            print("\033[31mOpção inválida, por favor tente novamente.")
